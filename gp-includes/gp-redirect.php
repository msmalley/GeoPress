...
class GP_Route {
	...
	function redirect( $url = null ) {
		...
		$this->set_notices_and_errors();
		// TODO: do not redirect to maps, but to /
		// currently it goes to /maps, because / redirects too and the notice is gone
		if ( is_null( $url ) )  $url = isset( $_SERVER['HTTP_REFERER'] )? $_SERVER['HTTP_REFERER'] : gp_url( '/maps' );
		gp_redirect( $url );
