<?php
class GP_Map extends GP_Thing {
	
	var $table_basename = 'maps';
	var $field_names = array( 'id', 'name', 'slug', 'path', 'latlng', 'description', 'type', 'zoom', 'height', 'numberofmarkers', 'parent_map_id', 'source_url_template', 'private', 'created', 'updated', 'display_type' );
	...
	/**
	 * Updates this map's and its chidlren's paths, according to its current slug.
	 */
